...
import useTablesHook from '@/app/hooks/useTables';

export default function Page(){
  const {tables, getTables, createTable, deleteTable, updateSafetyCode} = useTablesHook()
  return (
    <>
      ...
      <div className="w-full flex flex-row gap-3 flex-wrap justify-start items-center">
        {tables && tables.map((e: any, i: number) => <TableCard data={e} key={i} actions={{deleteTable, updateSafetyCode}}/>)}
