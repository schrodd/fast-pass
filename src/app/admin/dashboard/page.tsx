      ...
      <div className="w-full flex flex-row gap-3 flex-wrap justify-start items-center">
        {Object.keys(commerce).length <= 0 && (
          <ChildrenDuplicator amount={5}>
            <div className={`container w-[48%] md:w-[19%] h-32 bg-slate-100 px-6 py-3 text-slate-800 rounded-2xl shadow flex flex-col justify-center items-center relative overflow-hidden animate-pulse`}/>
          </ChildrenDuplicator>
        )}
